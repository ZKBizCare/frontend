    ...
    <Box className="container" py={8}>
      <VStack spacing={6} align="center">
        ...
        <VStack spacing={4} align="center" mb={6}>
          <Box className="card" p={4} borderRadius="md" width="100%" maxWidth="600px">            
            <Box display="flex" justifyContent="space-between">
              <Box flex="1" p={4} borderRadius="md" bg="rgba(255, 255, 255, 0.1)" mr={2} boxShadow="0 4px 6px rgba(0, 0, 0, 0.1)">
              ...
              <Box flex="1" p={4} borderRadius="md" bg="rgba(255, 255, 255, 0.1)" boxShadow="0 4px 6px rgba(0, 0, 0, 0.1)">
                <VStack spacing={3} align="center">
